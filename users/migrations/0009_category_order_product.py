# Generated by Django 3.1.5 on 2022-11-01 06:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_category', to='users.category', verbose_name='카테고리')),
            ],
            options={
                'verbose_name': '상품',
